...
<body>
  <!-- AUTHOR JEAN PAUL WWW.JEANWEB.COM.BR / jeanpaulrodrigues@hotmail.com-->
	<div class="container">

		<header class="masthead">
			<h2 class="muted"><img src="img/logo.png">  CRUD PDO + Bootstrap</h2>
			<nav class="navbar">
			...
			if(isset($_POST['enviar'])){
				...
				$sql  = 'INSERT INTO crudpdo (nome, email) ';
			...
			if(isset($_POST['atualizar'])){
				...
				$sqlUpdate = 'UPDATE crudpdo SET nome = ?, email = ? WHERE id = ?';
			...
			if(isset($_GET['action']) && $_GET['action'] == 'delete'){
				...
				$sqlDelete = 'DELETE FROM crudpdo WHERE id = :id';
		...
		<article>
			...
			<section class="jumbotron">
				...
				if(isset($_GET['action']) && $_GET['action'] == 'update'){
					...
					$sqlSelect = 'SELECT * FROM crudpdo WHERE id = :id';
